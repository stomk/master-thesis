\subsection*{Genome assembly of three medaka strains}
  ...
  % TODO: move this subsection to the introduction?
...
\subsection*{Validation of centromeric sequence assembly}
  Repetitive nature of centromeric sequences often accompanies the possibility of misassembly \cite{}. In order to validate the assembly at the centromeric regions, PacBio raw subreads were mapped to the assembled genomes and a visual inspection was conducted.

  % TODO: describe possible solutions for validating centromeric sequence assembly or current lack of it.

  PacBio subread were mapped to the medaka genomes by BLASR \cite{} with a stringent mapping parameters. The assembly validity was then visually inspected by confirming an enough number of subreads covered the centromeric repeat arrays. Most part of the centromeric sequences were covered by an enough number of subreads, although  a small number of exceptions were observed in chromosomes 9, 13 and 20 in the Hd-rR genome, which contained one or two breaking points that were not spanned by subreads (Supplementary Fig. \ref{centromere_landscape}).
...
\subsection*{Inter-chromosomal centromeric sequence conservation}
  ...
  % TODO: Add description on sequence conservation of acrocentric chromosomes in the human genome to support the result.
